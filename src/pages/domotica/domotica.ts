...
/**
 * Generated class for the DomoticaPage page.
 *
  ...
  read() {
    this.bluetoothSerial.read().then((data) => {
      if (data) {
        ...
        if(this.potenza != 0) {
          if ((this.potenzaMin == 0) || (this.potenza < this.potenzaMin)) {
            this.potenzaMin = this.potenza;
          }

          if (this.potenza > this.potenzaMax) {
            this.potenzaMax = this.potenza;
          }

          let mean = (this.potenzaMed + this.potenza) / 2;
          this.potenzaMed = parseFloat(mean.toFixed(2));
        }
        // console.table(data);
      }
    });
